...
define("skrollr", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.skrollr;
    };
}(this)));
...
define('views/listing',["backbone", "swipe", "bs/tab"], function(Backbone, Swipe) {
...
*/
;
define('routes/app',["backbone", "views/listing"], function(Backbone, Listing) {
